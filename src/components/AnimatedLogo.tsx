    ...
    return (
        <>
            ...
            >
                ...
                />
                <path
                    d="m 93,173 c -4.3,3.6 -24.1,28.5 -51.5,-2.9 -15.7,-17.8 -14.5,-21.5 -14.5,-21.5 0,0 16.7,8.5 34.8,0.3 17.1,-7.2 31.6,-3.3 45.2,10.3 0,0 2.7,1.5 3.6,4.5 0.1,4.7 -0.7,21.4 -0.2,23.8 -0.8,2.3 -2.1,-13.8 -2.4,-17.6 -1.9,-7.7 -12.2,-15.1 -34.2,-7.5 15.7,-0.5 28.2,3.2 30.2,3.2 -6.2,2.3 -7.8,3.5 -9.2,4.4 z"
                    id="logo-left"
                />
                <path
